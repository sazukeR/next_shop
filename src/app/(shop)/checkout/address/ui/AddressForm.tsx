...
interface Props {
 countries: Country[];
 userStoreAddress?: Partial<Address>; // el partial basicamente dice que todas la propiedades que tiene el user address son opcionales ahora
}
...
export const AddressForm = ({ countries, userStoreAddress = {} }: Props) => {
 ...
 useEffect(() => {
  // si ahi un valor aqui, quiere decir que ya podemos cargarlo en nuestro gestor de zustand
